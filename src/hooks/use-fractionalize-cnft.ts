  ...
  >({
    mutationFn: async (params) => {
      ...
      try {
        ...
        // The program likely expects the delegate to match the owner for transfer authority
        const leafDelegate = assetWithProof.leafDelegate
          ? new PublicKey(assetWithProof.leafDelegate) 
          : wallet.publicKey;
        
        console.log('👤 Leaf delegate:', leafDelegate.toBase58(), '(owner:', wallet.publicKey.toBase58(), ')');
        ...
        // Send transaction with skipPreflight for large transactions
        ...
        try {
          ...
          if (errorMessage.includes('already been processed')) {
            ...
            return {
              signature: signature.slice(0, 88), // Base64 signature
              assetId: params.assetId,
              treasury: treasury.publicKey.toBase58(),
            };
          }
